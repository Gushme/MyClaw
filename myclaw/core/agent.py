...
def create_agent_app(
    ...
    if tools is None:
        ...
        actual_tools = BUILTIN_TOOLS + dynamic_tools # 内置固定 + 可插拔
    else:
        actual_tools = tools
    ...
    def agent_node(state: AgentState, config: RunnableConfig) -> dict:
        ...
        final_msgs, discarded_msgs = trim_context_messages(raw_messages, trigger_turns=40, keep_turns=10) # 触发阈值40，保留回合10
        state_updates = {}
